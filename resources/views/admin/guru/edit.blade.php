...
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-8 col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="/admin/guru/{{ $guru->nip }}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="form-group">
                        <label for="nama">Nama</label>
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror " id="nama" value="{{ old('nama', $guru->nama) }}" required>
                        @error('nama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="nip" class="form-control @error('nip') is-invalid @enderror" id="nip" value="{{ old('nip', $guru->nip) }}" required>
                        @error('nip')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
