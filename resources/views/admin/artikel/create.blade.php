...
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-8 col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form action="/admin/linagar" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" value="{{ old('slug') }}" required hidden>
                        @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="kategori_id" id="kategori" style="width: 100%" required>
                            <option value="">...</option>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <input type="file" name="image[]" class="dropify" id="imageMaster" data-max-file-size="1M" data-height="250" data-allowed-file-extensions="png jpg jpeg" />
                        </div>
                        <div class="col-lg-4 col-md-4 col-12">
