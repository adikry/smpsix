...
<nav style="--bs-breadcrumb-divider: '>';" class="pt-5 mt-3" aria-label="breadcrumb">
    <div class="container">
        <ol class="breadcrumb border-custom">
            ...
            <li class="breadcrumb-item my-2 active" aria-current="page"><strong>Guru</strong></li>
        </ol>
    </div>
</nav>
...
<section class="section-padding pt-4">
    <div class="container">
        <h5 class="fs-1 text-center mb-4 mt-3">Daftar Guru SMPN 6 Garut</h5>
        <div class="row g-3">
            ...
            <div class="col-lg-3 col-md-3 col-6">
                <div class="custom-block-wrap border">
                    <div class="block-image" style="max-height:330px;min-height:330px;padding:15px">
                        @if ($guru->foto)
                        <img src="{{ asset('storage/') . '/' . $guru->foto}}" class="custom-block-image img-fluid rounded" alt="" />
                        @else
                    ...
                    <div class="custom-block border-bottom" style="min-height: 75px;max-height:75px">
                        <div class="custom-block-body pb-0">
                            <h5><small>{{ $guru->nama }}</small></h5>
                            <h5><small>Tugas : {{ $guru->mapel }}</small></h5>
                        </div>
                    </div>
                </div>
            </div>
